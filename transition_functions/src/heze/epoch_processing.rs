...
use types::{
    ...
    config::Config,
    gloas::containers::BuilderPendingPayment,
    heze::beacon_state::BeaconState,
...
mod spec_tests {
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/justification_and_finalization/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/justification_and_finalization/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/inactivity_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/inactivity_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/rewards_and_penalties/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/rewards_and_penalties/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/registry_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/registry_updates/*/*"
    )]
    fn minimal_registry_updates(case: Case) {
        run_registry_updates_case::<Minimal>(case);
    }

    #[test_resources("consensus-spec-tests/tests/mainnet/heze/epoch_processing/slashings/*/*")]
    fn mainnet_slashings(case: Case) {
        run_slashings_case::<Mainnet>(case);
    }

    #[test_resources("consensus-spec-tests/tests/minimal/heze/epoch_processing/slashings/*/*")]
    fn minimal_slashings(case: Case) {
        run_slashings_case::<Minimal>(case);
    }

    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/eth1_data_reset/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/eth1_data_reset/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/effective_balance_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/effective_balance_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/slashings_reset/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/slashings_reset/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/randao_mixes_reset/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/randao_mixes_reset/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/historical_summaries_update/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/historical_summaries_update/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/participation_flag_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/participation_flag_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/sync_committee_updates/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/pending_deposits/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/pending_deposits_churn/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/pending_deposits/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/pending_deposits_churn/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/pending_consolidations/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/pending_consolidations/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/proposer_lookahead/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/proposer_lookahead/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/heze/epoch_processing/builder_pending_payments/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/heze/epoch_processing/builder_pending_payments/*/*"
    )]
    fn minimal_process_builder_pending_payments(case: Case) {
        run_process_builder_pending_payments_case::<Minimal>(case);
    }

    #[test_resources("consensus-spec-tests/tests/mainnet/heze/epoch_processing/*/*/*")]
    fn mainnet_epoch_processing(case: Case) {
        run_epoch_case::<Mainnet>(case);
    }

    #[test_resources("consensus-spec-tests/tests/minimal/heze/epoch_processing/*/*/*")]
