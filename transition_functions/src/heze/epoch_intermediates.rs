...
mod spec_tests {
    ...
    #[test_resources("consensus-spec-tests/tests/mainnet/heze/rewards/*/*/*")]
    fn mainnet(case: Case) {
        run_case::<Mainnet>(case).expect("heze rewards test should not return an error")
    }

    #[test_resources("consensus-spec-tests/tests/minimal/heze/rewards/*/*/*")]
    fn minimal(case: Case) {
        run_case::<Minimal>(case).expect("heze rewards test should not return an error")
    }
