...
impl<P: Preset> Network<P> {
    ...
    fn handle_request(
        ...
        match request_type {
            ...
            RequestType::ExecutionPayloadEnvelopesByRange(request) => {
                self.handle_execution_payload_envelopes_by_range_request(peer_id, inbound_request_id, request)
            }
            RequestType::ExecutionPayloadEnvelopesByRoot(request) => {
                self.handle_execution_payload_envelopes_by_root_request(peer_id, inbound_request_id, request);
                Ok(())
            }
    ...
    fn handle_execution_payload_envelopes_by_range_request(
        ...
        let gloas_fork_slot = misc::compute_start_slot_at_epoch::<P>(
            self.controller.chain_config().gloas_fork_epoch,
        );
        ...
        self.dedicated_executor
            .spawn(async move {
                ...
                let envelopes = controller
                    .execution_payload_envelopes_by_range(start_slot..end_slot)?;
    ...
    fn handle_execution_payload_envelopes_by_root_request(
        ...
        self.dedicated_executor
            .spawn(async move {
                ...
                let envelopes = controller
                    .execution_payload_envelopes_by_roots(block_roots)?;
    ...
    fn handle_response(
        ...
        match response {
            ...
            Response::ExecutionPayloadEnvelopesByRange(None) => {
                ...
                P2pToSync::ExecutionPayloadEnvelopesByRangeRequestFinished(
                    peer_id,
                    app_request_id,
                )
                .send(&self.channels.p2p_to_sync_tx);
            ...
            Response::ExecutionPayloadEnvelopesByRoot(None) => {
                ...
                P2pToSync::ExecutionPayloadEnvelopesByRootRequestFinished(
                    peer_id,
                    app_request_id,
                )
                .send(&self.channels.p2p_to_sync_tx);
