...
impl<P: Preset> SyncManager<P> {
    ...
    pub fn remove_peer(&mut self, peer_id: &PeerId) -> Vec<SyncBatch<P>> {
        ...
        self.block_requests
            ...
            .chain(self.execution_payload_envelope_requests.remove_peer(peer_id))
            .collect_vec()
    }
    ...
    pub fn retry_batch(
        ...
        match new_peer {
            Some(peer_id) => {
                if matches!(
                    batch.target,
                    SyncTarget::Block | SyncTarget::BlobSidecar | SyncTarget::ExecutionPayloadEnvelope
                ) {
                    self.log(
                        Level::Debug,
    ...
    pub fn ready_to_request_by_range(&mut self) -> bool {
        self.block_requests.ready_to_request_by_range()
            ...
            && self.execution_payload_envelope_requests.ready_to_request_by_range()
    }
    ...
    pub fn add_execution_payload_envelope_request_by_root(
        ...
        self.log(
            Level::Debug,
            format_args!(
                "add execution payload envelope request by root (block_root: {block_root:?}, peer_id: {peer_id})",
            ),
        );
    ...
    pub fn expired_execution_payload_envelope_range_batches(
        ...
        self.execution_payload_envelope_requests.expired_range_batches()
    }
