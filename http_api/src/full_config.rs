...
use types::{
    altair::consts::{
        ...
        SyncCommitteeSubnetCount, TARGET_AGGREGATORS_PER_SYNC_SUBCOMMITTEE, TIMELY_HEAD_FLAG_INDEX,
    ...
    phase0::{
        consts::{
            ...
            BLS_WITHDRAWAL_PREFIX, DOMAIN_AGGREGATE_AND_PROOF, DOMAIN_BEACON_ATTESTER,
            DOMAIN_BEACON_PROPOSER, DOMAIN_DEPOSIT, DOMAIN_RANDAO, DOMAIN_SELECTION_PROOF,
            DOMAIN_VOLUNTARY_EXIT, DepositContractTreeDepth, ETH1_ADDRESS_WITHDRAWAL_PREFIX,
            FAR_FUTURE_EPOCH, GENESIS_EPOCH, GENESIS_SLOT, INTERVALS_PER_SLOT,
            JustificationBitsLength, TargetAggregatorsPerCommittee,
        },
